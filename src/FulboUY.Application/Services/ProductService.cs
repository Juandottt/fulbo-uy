...
public class ProductService : IProductService
{
    ...
    public async Task<ProductDto> CreateAsync(string name, string? description, decimal price)
    {
        Validate(name, price);
    ...
    public async Task<ProductDto> UpdateAsync(Guid id, string name, string? description, decimal price)
    {
        Validate(name, price);
